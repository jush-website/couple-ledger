...
// 從截圖中整理出的常見歷史 ID 清單 ( Scanner 會自動找這些資料夾 )
const KNOWN_APP_IDS = [
  "couple-ledger-pro",
  "c_1fd1d29ae268f2da_CoupleLedgerApp_Pro_jsx-201",
  "c_1fd1d29ae268f2da_CoupleLedgerApp_Pro_jsx-399",
  "c_1fd1d29ae268f2da_CoupleLedgerApp_Pro_jsx-878",
  "c_1fd1d29ae268f2da_CoupleLedgerApp_Pro_jsx-90d",
  "c_389f4b0e6873870c_App_jsx-292",
  "c_389f4b0e6873870c_App_jsx-611",
  "c_389f4b0e6873870c_App_jsx-9bb",
  "c_80bf02e0e339fd70_CoupleLedgerApp_jsx-1b9",
  "c_671b08e6b2080fa4_crc_CoupleLedgerApp_jsx-127",
  "c_671b08e6b2080fa4_crc_CoupleLedgerApp_jsx-476",
  "c_671b08e6b2080fa4_crc_CoupleLedgerApp_jsx-80b",
  "c_662b20b32f023162_CoupleLedgerWithGold_jsx-f83",
  "c_662b20b32f023162_crc_App_jsx-13",
  "c_662b20b32f023162_crc_App_jsx-318",
  "c_662b20b32f023162_crc_App_jsx-4e6",
  "c_662b20b32f023162_crc_App_jsx-6aa",
  "c_662b20b32f023162_crc_App_jsx-e0",
  "c_662b20b32f023162_crc_App_jsx-791",
  "c_662b20b32f023162_crc_App_jsx-89c",
  "c_bd6880b1bbc614d3_App_jsx-228",
  "c_bd6880b1bbc614d3_App_jsx-248",
  "c_bd6880b1bbc614d3_App_jsx-299",
  "c_bd6880b1bbc614d3_App_jsx-439",
  "c_bd6880b1bbc614d3_App_jsx-f6",
  ...
  <div className="space-y-6 animate-[fadeIn_0.5s_ease-out]">
    <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
      ...
      <div className="mt-6 border-t border-gray-100 pt-6">
        <h3 className="text-sm font-bold text-gray-800 mb-4 flex items-center gap-2"><Settings size={16}/> 進階：手動切換資料庫</h3>
        <div className="bg-gray-50 p-4 rounded-xl space-y-3">
          <div className="flex gap-2">
            <input 
                ...
                placeholder="貼上資料夾 ID..."
                className="flex-1 p-2 rounded-lg text-xs font-mono border border-gray-200 outline-none focus:ring-2 focus:ring-blue-400 bg-white"
            />
          </div>
          <div className="flex gap-2 mt-2">
              <button onClick={handleSwitchAppId} className="flex-[2] py-2 bg-gray-800 text-white rounded-lg text-xs font-bold shadow-sm active:scale-95 transition-transform">強制切換</button>
